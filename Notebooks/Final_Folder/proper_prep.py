...
def clean_for_model(df):    
    ...
    df = df[['tourney_id', 'draw_size', 'winner', 'surface',
       ...
       'player_1_rank_points', 'player_2_rank_points', 'player_1_wins', 'round_BR', 'round_ER', 'round_F', 'round_QF', 'round_R128', 'round_R16', 'round_R32', 'round_R64', 'round_RR', 'round_SF', 'player_1_hand_R', 'player_1_hand_L', 
